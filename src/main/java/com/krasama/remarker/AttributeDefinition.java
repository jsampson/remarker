...
public class AttributeDefinition
{
            ...
            Map<String, DTD> dtdsByElement)
    {
        ...
        this.typesByElement = Collections
                .unmodifiableMap(new HashMap<String, Type>(typesByElement));
        this.dtdsByElement = Collections
                .unmodifiableMap(new HashMap<String, DTD>(dtdsByElement));
    }
}
